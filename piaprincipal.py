...
Contactos.append(Contacto("01MG","Eduardo Flores","mrlnsr@gmail.com",8120123458, datetime.date(year=1998,month=12,day=29),1023))
Contactos.append(Contacto("02AL","Karian Frias","karinalefrias@gmail.com",8117883966, datetime.date(year=2000,month=05,day=13),1222))
CuantosElementosHay()
...
def principal():
    while (True):
        ...
        if RegEx(opcion_elegida,"^[123450]{1}$"):
            ...
            input("presione enter contunuar...")
        else:
